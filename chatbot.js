...
=== SAFETY & COMPLIANCE ===
Operating Safety: Observe the maximum permissible gross vehicle weight and axle load at all times. Do not overload the vehicle, as overloading may result in vehicle damage, loss of control, or personal injury. Replace any seat belt that has been subjected to impact forces in a collision, even if no visible damage is Warning present. Warning Never coast downhill in neutral.
Eco Driving: The following practices will help maximize driving range and energy efficiency:; Maintain a steady speed and avoid harsh acceleration or braking.; Keep the vehicle in good working condition through regular maintenance.; Never coast in neutral gear, as this will cause insufficient lubrication of the E-axle, leading to component damage.
Winter Driving: Preparation for winter driving; Use high-quality coolant based on the lowest temperature, and the freezing point of the coolant should be lower than local minimum temperature.; Ensure that the battery is fully charged at all times to prevent the battery from freezing under low temperatures.
Use of Snow Chains: When using snow chains, pay attention to the following:; It is recommended to use snow chains when driving on roads covered with thick layers of snow or ice.; Snow chains must be compatible with the tire size and type fitted to the vehicle.; Fit snow chains to the outer tires of the drive axle (both sides).; Take care not to damage the tires when fitting or 
Driving in Tropical/Hot Areas: Check the condition of the vehicle before driving:; Check that the coolant level is within the normal range and inspect for leaks.; Do not leave flammable items (e.g., lighters, aerosol products, perfumes) on the instrument panel or in direct sunlight for extended periods.
Ramp Driving (Hill/Slope): Precautions for uphill driving; If the vehicle rolls back when starting on an incline, depress the brake pedal immediately, apply the electronic parking brake, and then restart the driving procedure.; When climbing, maintain a low and steady speed. Apply the accelerator progressively and avoid sudden acceleration or braking.
Genuine Parts / Warranty: Windrose will not provide warranty coverage for parts under the following circumstances:; Unauthorized vehicle modifications, particularly to systems related to driving safety (e.g., high-voltage systems, electrical systems, braking, steering, or TBOX).; Tampering with the vehicle's OBD system.; Use of non-approved parts or fluids that result in safety
Data Security: In accordance with applicable laws and regulations, Windrose collects and processes vehicle data including location information, driving behavior data, audio and video recordings, and personal information.
Vehicle Modification: Materials required prior to modification Any vehicle modification must comply with applicable technical and regulatory requirements. Prior to modification, relevant technical documentation must be submitted to Windrose.
Vehicle Scrapping / HV Battery Recycling: Vehicles that no longer meet roadworthiness requirements must be disposed of in accordance with applicable environmental regulations. Vehicle scrapping and high-voltage battery recycling must be performed by Windrose or authorized recycling organizations.
Reporting Safety Defects (NHTSA): If you suspect the vehicle has a safety-related defect, stop the vehicle in a safe location as soon as practicable and contact Windrose customer support or a Windrose authorized service station immediately. Windrose may issue safety notices, service campaigns, or recalls where required by applicable laws and regulations.

=== VEHICLE OVERVIEW ===
Vehicle Exterior:; Front indicator lamp/daytime running lamp; Parking lamp 3. Panoramic sunroof 4. Side toolbox 5. Charging port 6. Side marker combination lamp 7. Electric sliding door 8. Rearview mirror 9. Front outline marker lamp 10. Identification lamp/charging indicator 11. Windshield wiper 12. Side indicator lamp 13. Low beam 14. High beam
Vehicle Interior: 1. Brake pedal 2. Cup holders (left) 3. Instrument panel left combination button 4. Steering wheel 5. In-vehicle infotainment screen 6. Kinetic regenerative braking paddle (left) 7. Instrument cluster 8. Instrument panel storage box/AR-HUD* 9. Kinetic regenerative braking paddle (right) 10. Car control screen 11. Instrument panel right combination 12.
VIN / Vehicle Nameplate: Vehicle nameplate; The vehicle nameplate is located on the right sliding door frame (C-pillar) of the vehicle.; The nameplate displays the following information: Manufacturer's name; Whole Vehicle Type Approval (WVTA) number; Number (VIN); Intended registration maximum permissible mass; Technically permissible maximum laden mass; Other regulatory inform

=== INTERIOR FEATURES ===
Electric Sliding Door: electric sliding door is installed on the right side of the vehicle. The door can be opened or closed using several operating methods. Operating instructions Exterior operation Electric: When the vehicle is unlocked, press the flush door handle switch. The electric sliding door will automatically open or close. Manual: When the vehicle is unlocked: 1.
Seat Belt: driver and front passenger seats are equipped with seat belts. Seat belts help prevent or reduce injury to occupants during emergency braking or a collision. Operating instructions The driver seat belt is located on the left side of the driver seat and can be pulled out directly to fasten.
Power Window: side windows can be operated using the window control switches located on the left side of the instrument panel or on the sleeper control panel. The vehicle is equipped with an automatic window closing function. When the vehicle is powered off and locked, the windows will automatically close if they are not already fully closed.
Sleeper Privacy Curtain: sleeper area is equipped with privacy curtain rails that allow installation of privacy curtains. The curtains help provide privacy and reduce sunlight in the sleeper area. * This feature is available on certain vehicle models only. Operating instructions Sleeper privacy curtain rail The curtain rails are installed on the roof above the sleeper area.
Panoramic Sunroof: vehicle is equipped with a panoramic roof and an electric sunshade. The panoramic roof is fixed and non-operable. It allows natural light into the cab and provides an outside view. The sunshade can be opened or closed to block sunlight when required.
Windshield Electric Sunshade: driving toward strong sunlight, the windshield electric sunshade can be used to reduce glare and improve driving comfort.
Interior Sleeper: the vehicle, there are sleepers for the driver and passengers to rest. Operating instructions The upper right cushion of the sleeper can be manually flipped and folded to the left to make room for the front passenger seat.
Rearview Mirror: rearview mirrors are mounted on the vehicle to provide the driver with a efficient driving view.
Cup Holder: holders are positioned on the left and right sides of the instrument panel separately, as well as on the armrest of the front passenger seat, so that you can place water cup or beverage container in the corresponding cup holder.; Cup holders (left); Cup holders (right) • Cup holder on right side of front passenger seat Precautions Warning Do not put hot drinks in th
Ash Tray: is an ashtray on the vehicle for the convenience of storing cigarette butts and ashes. Operating instructions The ashtray is mounted in the cup holder on the right side of the instrument panel. You can put the ashtray in other positions according to your individual needs.
Side Toolbox: driver's tools of the vehicle are placed in the toolbox on the left side of the vehicle for use in case of an emergency. Operating instructions You can unlock the toolbox by selecting "Control Center", switching to "Outside" interface, and clicking "Toolbox Unlock" button on the vehicle information screen of the instrument panel.
Interior Storage: are multiple storage devices in the vehicle for you to store items of different sizes.
Net Bag: is a net bag on the lower left of the vehicle to hold some smaller items. Operating instructions; Net bag Precautions Note Do not place sharp objects in the net bag to avoid damage to the net bag or injury to the driver.
Coat Hook / Hanging Device: is a coat hook above the sleeper that is used for hanging clothes up. Operating instructions; Coat hook Precautions Note The coat hook can only hold light clothes or hats, etc. Do not hang heavy objects. is a hanging device on the side of the sleeper that can be used to hang towels or small clothes.
USB Charging: vehicle is provided with USB ports, respectively located on the left instrument panel and the armrest of the front passenger seat. The USB ports can be used to charge mobile phone with a charging power of 15W. Both type-C and type-A ports are supported.
Phone Wireless Charging: The right instrument panel is equipped with a wireless charging device, which can be used to charge mobile phones wirelessly with a charging power of 15W.
Power Outlet (230V/110V): lower left corner of the sleeper is equipped with 2 DC power supplies, configured as: Rated voltage: 24V; Maximum current: 15A Rated voltage: 12V; Maximum current: 10A The lower left corner of the sleeper is equipped with one 120V inverter and socket, configured as follows:; Rated power: 1000W; Rated voltage: AC120V; Output frequency: 60Hz ± 0.5Hz Oper
Ceiling Lamp: Lighting The ceiling lamp can be turned on and off in two ways.; Ceiling lamp on switch; Ceiling lamp/interior lamp off switch Press the upper ceiling lamp on switch to turn on the ceiling lamp; Press and release the lower ceiling lamp/interior lamp off switch to turn off the ceiling lamp, and press and hold the upper ceiling lamp/interior lamp off switch to turn 
Courtesy Lamp: vehicle has welcome light function. Interior Lighting You can activate/deactivate low beam welcome function by selecting "Control Center", switching to "Lighting" interface, and clicking "Low Beam Welcome" button on the vehicle information screen of the instrument panel. Follow-me-home
Reading Lamp: Lighting The cab and the sleeper are equipped with reading lamps that can be turned on when you need reading lighting. Operating instructions Cab reading lamp You can activate/deactivate the follow-me-home function by selecting "Control Center" and switching to "Lighting" interface on the vehicle information screen of the instrument panel.
Ambient Lamp: Lighting while driving. Otherwise the windshield may have reflections, resulting in unclear visibility of the road ahead and further a safety accident. The vehicle has ambient lamps that can switch among a variety of colors and realize musical rhythm.
A/C Control System: A/C on Vehicle can set and control the A/C through the A/C interface in the vehicle information screen or through the A/C control panel on the upper right of the sleeper in the vehicle.
A/C Vent Adjustment: A/C on Vehicle front A/C vents are located in the windshield, the instrument panel and the legroom under the instrument panel. The rear A/C vents are located on the left side of the sleeper in the vehicle.
In-Vehicle Fragrance: A/C on Vehicle vehicle has an in-vehicle fragrance device, which can be mounted in the fragrance box in the lower trim area on the right side of the driver seat according to your personal preferences.

=== CHARGING & PRE-DRIVE ===
Charging Port:; Charging port The vehicle has charging ports on both sides.
Charging Preparation: Vehicle Charging charging this vehicle, please use a charging device with a voltage ≥ 1000V to charge the vehicle. Charging devices smaller than this standard will not be able to charge the vehicle.
Driving Preparation: Preparation Before Driving Before using the vehicle, check it to ensure safety:; Check the connection and fastening of each part.; Check whether the motor and E-axle make abnormal noise during working.; Check the installation of the accessories.; Check the oil level in the E-axle and steering oil tank.; Check the fluid level in the windshield washer and coo
Driver Seat Adjustment: Preparation Before Driving can adjust the functions of the driver seat according to your personal needs and preferences to deliver more comfortable experience during driving.
Front Passenger Seat: Preparation Before Driving front passenger seat is situated on the right side of the sleeper in the vehicle. You can uncover the headrest of the sleeper and adjust the backrest of the front passenger seat in vertical position to sit in the front passenger seat.
NFC Card: Preparation Before Driving vehicle is designed with a NFC Card, which allows you to unlock, lock, power ON and power OFF the vehicle.
Mechanical Key: Preparation Before Driving the vehicle cannot be unlocked using digital key and NFC Card under certain special circumstances, you can use the mechanical key to unlock the vehicle in an emergency.; When you press the front end of the flush door handle, the rear end of the flush door handle will tilt.
Steering Wheel Adjustment: Preparation Before Driving steering wheel can be adjusted forward, backward, up and down to suit your driving needs. Warning; Never adjust the steering wheel while driving to avoid accidents.; After adjusting the steering wheel position, make sure that the steering wheel is locked, otherwise it will cause personal injury or death and property damage.
Steering Wheel Buttons: Preparation Before Driving; Pull up the steering wheel adjustment handle to unlock the steering wheel.; Manually adjust the steering wheel height and distance to your body according to your needs.; After the adjustment is completed, push down the steering wheel adjustment handle to lock the steering wheel.

=== INSTRUMENT CLUSTER & CONTROLS ===
Instrument Cluster Overview: Preparation Before Driving; Trip 5. Driving mode 9. Current vehicle gear 13. Instantaneous power consumption per 100 miles; Estimated driving range 6. High voltage battery capacity 10.Energy recovery levels; Odometer (total distance) 7. Current speed 11.Proportion of instantaneous power driven; Exterior temperature 8. Vehicle is ready 12.
Warning Lamps & Indicators: Preparation Before Driving Icon Name Note Left direction indicator Illuminates when the left indicator is activated. Right direction indicator Illuminates when the right indicator is activated. Trailer left direction indicator Illuminates when the trailer left indicator is activated.
Wiper Control: Before Driving When you release the windshield washing button, the water spraying will stop immediately, and the wiper will reset after three wipes.
Light Switch (Headlights): Before Driving; Do not rely solely on the automatic wipers. Always adjust the wiping manually according to the actual situation.
Hazard Warning Lamp: Preparation Before Driving the case of an emergency while driving, immediately turn on the hazard warning lamp to alert the vehicle behind, thereby avoiding accidents.
Power ON/OFF (Starting Vehicle): After the vehicle is unlocked, open the door and swipe the NFC Card at the designated swiping position of the right instrument panel to power ON the vehicle, and the instrument cluster and center display will be illuminated. If you are in the vehicle, you can power ON or off the vehicle through the NFC Card.
Service Brake: With the EPB turned on, you can power OFF the vehicle by selecting "Control Center", switching to "Setting" interface, and clicking "Power OFF" button in the right IVI screen.
Electronic Parking Brake (EPB): Driving EPB Parking Brake Switch Status Indicator; EPB Parking Brake Switch Operating instructions Parking Brake Release; Manual Release When the vehicle is in the parking brake state with normal system self-check and air reservoir pressure, depress the brake pedal and press the EPB Parking Brake Switch to release the parking brake; the parking b
Emergency Braking While Driving: Driving parking brake can be used as an emergency brake when the vehicle's service brake system malfunctions. Operating instructions; For EPB electronic parking, it can be used as an emergency braking operation when the service brake fails.
Gear / Shift Operation: opening of the pull up switch, the greater the braking force applied. Precautions Warning; If the vehicle speed is high, the parking handle should be pulled in a similar way as a "spot brake". Do not tighten or lock it all at once to avoid damage to the brake and other related components and loss of braking efficiency.
Regenerative Braking (Energy Recovery): Turn the left paddle of kinetic regenerative braking system (KERS) to reduce the kinetic regenerative braking intensity of the vehicle during coasting. 2.
AR-HUD: Driving AR-HUD can project vehicle-related information onto the front windshield so that it is easier for you to obtain legible information rapidly while driving, thus improving driving safety.; Lane departure line prompt; Navigation arrow; Driving speed + driving mode; Instrument cluster warning icon; ACC status icon + cruise speed Operating instructions You can select
Differential Lock: Driving driving on muddy and slippery roads or when climbing under heavy loads, the drive wheels may slip or it may be difficult for the vehicle to move. In this case, you can use the vehicle differential lock to improve the passability of the vehicle.
Driving Mode (Eco/Normal): You can select the drive mode by selecting "Control Center" and switching to the "Setting" interface on the vehicle information screen of the instrument panel to tailor your needs.; ECO mode This vehicle has three driving modes, which offer you the chance to choose how you want to drive. Each mode provides a different driving experience.

=== ADAS & DRIVER ASSISTANCE ===
Around View Monitor (AVM) - 360 Camera: around view monitor (AVM) uses cameras installed around the vehicle to capture images, and the AVM module stitches and synthesizes the high-definition image signals collected by the cameras to achieve 2D/3D panoramic view. The area not covered by the panoramic view can be supplemented with the image from the rear camera.
Moving Off Information System (MOIS): MOIS system can monitor pedestrians/bicycles in blind spots ahead of the vehicle and operates effectively at low speeds to prevent collisions with pedestrians or cyclists.
Adaptive Cruise Control (ACC): adaptive cruise control (ACC) is a driver assistance function to improve the driver's comfort. If the road ahead is clear, the ACC will maintain the set maximum cruising speed and allow the vehicle to drive forward.
Low Speed Alarm & Reverse Warning: Reminder Device This car is equipped with a low-speed alarm and reverse reminder device, which will alert surrounding personnel and vehicles when you are driving at low speed or reversing.
Automatic Emergency Braking (AEB): automatic emergency braking (AEB) system can detect target vehicles or obstacles, predict a risk of potential forward collision, and send a warning signal and display the image on the vehicle information screen in case of a danger to remind the driver and activate the brake system of the subject vehicle to avoid or mitigate collisions by reduc
Electronic Braking System (EBS): electronic braking system (EBS), as a control system upgraded from the ABS and ESC, can reduce the response time and pressure building time of the braking system, realize the electronic brake force distribution of the vehicle and the consistency control of the tractor unit and trailer, shorten the braking distance and improve the overall braking
Electronic Brakeforce Distribution (EBD): Function introduction Electronic Brakeforce Distribution (EBD) ensures good braking performance and stability of the vehicle under different load conditions by regulating the distribution of braking forces between front and rear wheels and controlling the slip of rear wheels.
Acceleration Slip Regulation (ASR) / Traction Control: acceleration slip regulation (ASR) is an electronic system that monitors and controls the driving force of the driving wheels during driving on the basis of ABS.
Lane Departure Warning (LDW): the vehicle deviates from the current lane unconsciously, the lane departure warning (LDW) will alert the driver with visual and audible alarm sounds.
Electronic Stability Control (ESC): driving direction of the vehicle and ensure the stability of the direction.; Anti-rollover: When the vehicle is at risk of rollover, the ESC will reduce the motor torque or brake the vehicle to slow down the vehicle and prevent the vehicle from rolling over.
Blind Spot Information System (BSIS): BSIS system detects pedestrians and cyclists in the vehicle's blind spots. When the vehicle is stationary and detects an object entering the danger zone, the BSIS alarm screen immediately triggers an alert, with the dashboard indicator lights activating simultaneously.
ADDW (Driver Drowsiness Warning): Do not rely too much on the BSIS, and it is forbidden to test the triggering of the function intentionally or wait for the function to be triggered intentionally. Due to the inherent limitations of system performance, false triggering and missed triggering cannot be completely avoided.
Intelligent Speed Assistance (ISA): introduction The ISA system combines forward facing camera recognition and offline maps to detect speed limits. When the system detects the perceived speed limit, the dashboard will display the perceived speed limit of the current road.
Hill Start Assist (HSA): hill start assist (HSA) helps you prevent the vehicle from moving backward when starting on a slope. The HSA will keep the vehicle stationary on a slope for a short time after the brake pedal is released.
Tire Emergency Safety Device (TESD):; When replacing tires, the operator needs to remove the tire emergency safety device first, next remove the tire, install the new tire, and then refit the tire emergency safety device.
Electro-Hydraulic Power Steering (EHPS): Function introduction The electro-hydraulic power steering (EHPS) realizes steering assistance and intelligent driving assistance by controlling the hydraulic power output of power motor.
Electronic Air Suspension (ECAS): Function introduction The electronically controlled air suspension (ECAS) drives the solenoid valve in the control mechanism by collecting the height of the frame and the axle, airbag pressure, vehicle speed signal, braking signal and operation switch signal, to realize the inflation and deflation of the airbag, thereby achieving the raising an
Tire Pressure Monitoring System (TPMS): Function introduction This vehicle is equipped with a tire pressure monitoring system (TPMS), which allows you to check the tire pressure status of the vehicle at any time.
Multimedia / Infotainment System: Multimedia System You can click here to turn off the in-vehicle infotainment screen.; Application Center You can click here to view or use related applications.; Radio You can click here to switch to the radio interface and listen to local radio stations.; Local music You can view or play music files stored in the IHU system here.; Home page Yo

=== EMERGENCY PROCEDURES ===
Safety Hammer & Driver Tools: Towing hook When towing this vehicle, you need to install the towing hook in place first and ensure the stability of the vehicle on the towing vehicle.
Towing a Trailer: Vehicle Recovery and Towing When the vehicle cannot be driven due to breakdown or accident, contact a Windrose authorized service center immediately for professional recovery and towing service. Do not attempt to tow the vehicle without following proper procedures. Incorrect towing may cause serious vehicle damage, loss of braking, or a road traffic incident.
Brake Failure: Emergency operation; If the brake fails suddenly while driving, please turn on the hazard warning lamps immediately, hold the steering wheel firmly, and pay attention to avoid and alert passing vehicles by visual and acoustic alarms.; Slowly turn on the electronic parking brake, observe the driving conditions and use ramps or the runaway truck lane to assist park
Steering Failure / Loss of Control: Emergency operation; When you lose control of steering wheel suddenly while driving on common roads (straight driving), release the accelerator pedal first, turn on the hazard warning lamps as soon as possible, and depress the brake pedal evenly.; Before driving, check whether the steering wheel rotation meets the standard requirements.; Befo
Tire Burst / Blowout: Emergency operation After parking the vehicle, place the warning signs around the vehicle and block the wheels with wedges to prevent the vehicle from slipping, and call the Windrose service hotline. Prevention measures; Regularly maintain the steering system.
Vehicle Sideslip / Skid: Emergency operation Follow-up procedures; After parking the vehicle, place the warning signs around the vehicle and block the wheels with wedges to prevent the vehicle from slipping.; After the vehicle stops completely, contact a towing truck for rescue.
Accidental High Voltage Exposure: Emergency operation When the vehicle is powered off with high voltage accidentally while driving, the driver should:; Press the hazard warning lamp switch and try to start the vehicle again.; After the motor is working, be sure to pull over the vehicle for inspection and eliminate the potential risks before driving.; If the vehicle cannot be po
Emergency Evacuation: Emergency operation When an emergency situation occurs and the car door cannot be opened, you can follow the following steps for emergency evacuation. Follow-up procedures; Locate the emergency pull ring cover above the left net bag.
HV System Deactivation (Cutoff): Emergency Rescue High voltage cutoff from outside; Park the vehicle, apply the EPB.; Pull the hood release handle twice in a row to release the hood.; Find the low voltage MSD in the engine compartment and remove it, and the vehicle will deactivate the high-voltage system automatically.
Vehicle Fire Rescue: Emergency Rescue In the event of a vehicle fire, immediately assess the severity of the fire. If the fire is small and can be contained, emergency responders should use a suitable fire extinguisher such as a dry powder extinguisher, CO₂ extinguisher, or dry sand.
Wading Vehicle Rescue (Flood): Emergency Rescue A vehicle that has been driven through floodwater may show no obvious external damage, but the high-voltage system may be compromised and at risk of electrical leakage.
HV System Info for First Responders: Emergency Rescue; High voltage battery; Right CCS1 mode charging port; Left MCS mode charging port; High-voltage harness; Drive motor Notice; During startup and use, do not touch parts with "high voltage warning signs" or orange parts of the vehicle.; It is strictly forbidden to trample or bump the high-voltage battery of the vehicle.

=== MAINTENANCE ===
Why Maintenance is Essential: Daily Maintenance Regular routine and scheduled maintenance is essential to ensure safe operation, reliability, and optimal vehicle performance, and to help minimize long-term maintenance costs. Routine maintenance tasks described in this manual may be performed by the operator following the relevant instructions.
Electric Drive System Inspection: Daily Maintenance Before starting the vehicle, check whether the relevant data displayed on the instrument cluster is normal. If the data is abnormal, do not drive the vehicle. Instead, record the system fault type and related data, and report the information to the Windrose authorized service center.
Tire Pressure Monitoring & Check: Daily Maintenance This vehicle is equipped with a tire pressure monitoring system, which will display the tire pressure on the instrument cluster and the vehicle information screen. If the tire pressure is abnormal, closed during normal driving.
Lighting Inspection: Daily Maintenance vehicle is equipped with a self-test function for verifying functionality of each driving lamp. Operating instructions You can activate this function by selecting "Control Center", switching to the "Monitoring" interface and clicking "Driving Light Self-Test" button on the vehicle information screen of the instrument panel.
Horn & Wiper Inspection: Daily Maintenance Check the electric/air horns as below:; Park the vehicle, press the horn button on the steering wheel to check whether the electric horn is working properly.; Press the electric/air horn change-over switch, press the horn switch repeatedly, and check whether the air horn is working properly.; Power on the vehicle, turn on the wiper swi
High-Voltage Battery Maintenance: Position of high-voltage battery The high-voltage battery is located under the floor of the vehicle. When the vehicle is driving on bumpy or uneven roads, be careful to prevent collisions.
Coolant: Coolant selection Please select the coolant with the corresponding freezing point according to driving environment to ensure the normal operation of the vehicle cooling system.
Tire Maintenance: Tires are the connection to the road and affect driving safety. Check the following items of the tires regularly or before driving:; Tire pressure When checking tire pressure, note that the pressure will change with temperature.; Tread pattern The tread pattern affects the grip and control of the tire.
Steering System Maintenance: Before driving, check the free travel and looseness of the steering wheel, shake the steering wheel to ensure that it is locked. During driving, check whether there is heavy steering, shaking steering or steering offset.
High-Voltage Safety Maintenance: Principles of safe operation under high voltage Do not modify and install accessories on the high-voltage system and body of the vehicle without following proper procedures.

=== TECHNICAL SPECIFICATIONS ===
Battery Specifications: The low voltage battery is located in the engine compartment. The service life and function of the battery are affected by many factors, such as the number of starts, driving style, driving conditions, climatic conditions, etc.:; If the battery is completely discharged multiple times, its service life may be shortened.
Vehicle Dimensions (Outline Size): Technical Data Length (in) Width (in) Height (in) Wheelbase (in) 318.90 100.20 154.33, 154.92 183.07+53.15
Power System Parameters: Technical Data Item NCM LFP Drive motor Motor model TZ230XSSW001 Manufacturer Jiangsu Swell Industry Development Co., Ltd.
Fastening Torques: Technical Data Module Assembly Position Bolt Size Tightening Torque (lb-ft) Steering system Fixing slave rocker arm-subframe M14×2 (10.9) 154.9±14.8 M14×2 (10) Tie rod ball joint-relay rod/steering knuckle arm rocker arm M24×1.5 (8) 254.5±11.1 Fixing EHPS-subframe M20×1.5 (10.9) 405.7±14.8 Module Assembly Position Bolt Size Tightening Torque (lb-ft) Steering 
Tire Pressure Specifications: Technical Data Tire Specifications Type Rim Specifications Load Capacity (lb/kg/tire) Single Dual Inflation Pressure (psi) Wheel Position 295/80R22.5 18PRM 18 9.00×22.5 7810/3550 7150/3250 130.5 All position 315/70R22.5 20PR L Z2* 20 9.00×22.5 8800/4000 7370/3350 130.5 Steer 315/70R22.5 20PR L D2* 20 9.00×22.5 8250/3750 7370/3350 130.5 Drive 12R22.
Wheel Alignment Parameters: Technical Data Kingpin Inclination Wheel Camber Toe-In (in) 7.9°±45′ 0.25°±45′ –0.04~0.08
Gradability (Max Grade): Technical Data GVW Transmission Gear Gradeability 46t Gear D1 (Speed ≤7 mph) Three Motors Continuous Gradeability 15% Maximum Gradeability 30%(60s) Four Motors Continuous Gradeability 17% Maximum Gradeability 33%(60s) Gear D2 (Speed &gt;7 mph) Three Motors Continuous Gradeability 5% Maximum Gradeability 9%(60s) Four Motors Continuous Gradeability 6% Max
Air Reservoir Pressure: Technical Data Model Rated Working Pressure (psi) Starting Pressure (psi) Full series 174.0 108.8
Curb Weight, GVW, Axle Load, Drive Mode: Technical Data Model Mass Parameters Curb Weight Maximum Total Mass (lb) Axle Load (full load) Axle Load (empty) Drive Mode NCM 3 Motor 24,747.1 lb 57,320.1 lb 15,432.4/20,944.0/20,944.0 lb 11,516.2/6,778.7/6,449.6 lb 6×4 NCM 4 Motor 25,077.8 lb 57,320.1 lb 15,432.4/20,944.0/20,944.0 lb 11,516.2/6,778.7/6,778.7 lb 6×4 LFP 3 Motor 26,623.
Lamp Power: Technical Data; Front fog Lamp, Cornering lamp; High beam; Front indicator lamp, daytime running lamp; Front outline marker lamp; Front parking lamp; Low beam; Side indicator lamp; Side marker combination lamp; License plate lamp; Reversing lamp; Brake lamp/taillamp/indicator lamp; Rear retro-reflector; Rear working lamp; Side marker combination lamp; Side indicator
Protection Device Data (Fuses): Technical Data Name Material Connection Position Connection Method Diagram of Structural Dimensions Front underrun protection device 6110A-T6 Frame Bolt`;
