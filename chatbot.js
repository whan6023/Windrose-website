...
VEHICLE IDENTIFICATION: VIN is 17 digits. Positions 1-3: WEA (World Manufacturer Identifier). Position 4: series (4=WH12). Position 5: cab type (R=sleeper). Position 6: drive axle (A=6x4, B=8x4). Position 7: motor config (C=3-motor, D=4-motor). Position 8: battery type (C=NCM, F=LFP). Position 9: check digit. Position 10: model year. Position 11: plant code. Positions 12-17: serial number.

VEHICLE WEIGHTS: NCM 3-motor curb weight 23,700 lb; NCM 4-motor 24,030 lb; LFP 3-motor 26,092 lb; LFP 4-motor 26,433 lb. GVWR 55,116 lb. Maximum total mass 57,320 lb.
